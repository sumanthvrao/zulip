...
from zerver.views.hotspots import mark_hotspot_as_read, reset_all_hotspots
...
v1_api_and_json_patterns = [
    ...
    rest_path('users/me/hotspots',
              POST=(mark_hotspot_as_read, {'intentionally_undocumented'})),
    rest_path('users/me/reset_hotspots',
              POST=(reset_all_hotspots, {'intentionally_undocumented'})),

...
* [`GET /messages`](/api/get-messages) and [`GET
  /events`](/api/get-events): `topic_links` returns a list
  of objects each containing the `url` and `text` for links
  that are present in the topic or generated by linkifiers.
